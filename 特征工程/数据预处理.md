...
<a href="https://www.codecogs.com/eqnedit.php?latex=$$&space;x'&space;=&space;\dfrac{x-Min}{Max-Min}&space;$$" target="_blank"><img src="https://latex.codecogs.com/gif.latex?$$&space;x'&space;=&space;\dfrac{x-Min}{Max-Min}&space;$$" title="$$ x' = \dfrac{x-Min}{Max-Min} $$" /></a>
...
<a href="https://www.codecogs.com/eqnedit.php?latex=x'&space;=&space;\frac{x-\overline{x}}{S}" target="_blank"><img src="https://latex.codecogs.com/gif.latex?x'&space;=&space;\frac{x-\overline{x}}{S}" title="x' = \frac{x-\overline{x}}{S}" /></a>
